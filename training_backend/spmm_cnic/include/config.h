...
#define WARMUP_TIME 0 // 100
#define EXE_TIME    1 // 10

typedef uint32_t vint;
typedef uint4    row_int;


//#define ROW_WINDOW = 8; // 假设行窗口大小为 8
//#define COL_WINDOW = 8; // 假设列窗口大小为 8
//#define GROUP_LEN = 16; // 假设分组长度为 16
#define UINT32_MAX   0xFFFFFFFF  // 最大 32 位无符号数
